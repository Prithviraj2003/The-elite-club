        ...
        <>
            ...
            <div className='h-full  bg-[#000000] '>
                <div className='max-w-[1400px] bg-[#000000]  mx-auto'>
                    <div className='h-screen max-h-[600px] w-full mx-0'>
                        <img
                            src={'/homepageImg.png'}
                    ...
                    {/* 2 */}
                    <div className='h-auto max-h-[1200px] flex flex-col justify-center mx-auto w-full items-center bg-[#000000] text-[#ffffff] p-6 border-b border-[#3a3a3a]'>
                    ...
                    {/* 3 */}
                    <div className=' h-[100vh] max-h-[900px] bg-[#000000] text-[#ffffff] flex flex-col justify-center '>
                        <div className='flex ml-44 text-2xl p-2 pl-0'>
                            AS SEEN ON
                        </div>
                        <div className='flex flex-wrap gap-3 justify-center'>
                            {Array(4).fill(null).map(() => (
                                <div className='flex flex-col max-w-[250px]'>
                                    ...
                                    <div className='bg-[#353535] px-3 py-2 rounded-b-lg text-[#ffffff]'> the musicmonk  </div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className=' h-auto max-h-[1500px] bg-[#000000] text-[#ffffff] flex flex-col justify-center '>
                        <div className='flex justify-around w-full border-y border-green-500 p-1 mt-60'>
                        ...
                        <div className='w-[500px] bg-[#5630CE] h-[600px] mx-auto my-7 mt-20 rounded-xl flex flex-col py-12 items-center '>
                        ...
                        <div><img src="/Section.png" alt="" /> </div>
                    </div>
                    {/* 5 */}
                    <div className='h-[50vh] max-h-[700px] flex text-[#ffffff] px-20 mt-20 '>
